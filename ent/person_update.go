...
func (pu *PersonUpdate) SetObjectID(id uuid.UUID) *PersonUpdate {
	pu.mutation.SetObjectID(id)
	return pu
}

// SetObject sets the "object" edge to the Object entity.
func (pu *PersonUpdate) SetObject(o *Object) *PersonUpdate {
	return pu.SetObjectID(o.ID)
}
...
func (pu *PersonUpdate) ClearObject() *PersonUpdate {
	pu.mutation.ClearObject()
	return pu
}
...
func (pu *PersonUpdate) check() error {
	if _, ok := pu.mutation.ObjectID(); pu.mutation.ObjectCleared() && !ok {
		return errors.New(`ent: clearing a required unique edge "Person.object"`)
	}
	return nil
}
...
func (pu *PersonUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if pu.mutation.ObjectCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2O,
			Inverse: true,
			Table:   person.ObjectTable,
			Columns: []string{person.ObjectColumn},
			Bidi:    false,
	...
	if nodes := pu.mutation.ObjectIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2O,
			Inverse: true,
			Table:   person.ObjectTable,
...
// SetObjectID sets the "object" edge to the Object entity by ID.
func (puo *PersonUpdateOne) SetObjectID(id uuid.UUID) *PersonUpdateOne {
	puo.mutation.SetObjectID(id)
	return puo
}

// SetObject sets the "object" edge to the Object entity.
func (puo *PersonUpdateOne) SetObject(o *Object) *PersonUpdateOne {
	return puo.SetObjectID(o.ID)
}
...
// ClearObject clears the "object" edge to the Object entity.
func (puo *PersonUpdateOne) ClearObject() *PersonUpdateOne {
	puo.mutation.ClearObject()
	return puo
}
...
func (puo *PersonUpdateOne) check() error {
	if _, ok := puo.mutation.ObjectID(); puo.mutation.ObjectCleared() && !ok {
		return errors.New(`ent: clearing a required unique edge "Person.object"`)
	}
	return nil
}
...
func (puo *PersonUpdateOne) sqlSave(ctx context.Context) (_node *Person, err error) {
	...
	if nodes := puo.mutation.ObjectIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2O,
			Inverse: true,
			Table:   person.ObjectTable,

...
func (cu *CommentUpdate) SetScore(i int) *CommentUpdate {
...
func (cu *CommentUpdate) SetNillableScore(i *int) *CommentUpdate {
	if i != nil {
		cu.SetScore(*i)
	}
	return cu
...
func (cu *CommentUpdate) AddScore(i int) *CommentUpdate {
...
func (cu *CommentUpdate) SetObjectID(id uuid.UUID) *CommentUpdate {
...
func (cu *CommentUpdate) SetNillableObjectID(id *uuid.UUID) *CommentUpdate {
	if id != nil {
		cu = cu.SetObjectID(*id)
	}
	return cu
}

// SetObject sets the "object" edge to the Object entity.
func (cu *CommentUpdate) SetObject(o *Object) *CommentUpdate {
...
func (cu *CommentUpdate) AddChildIDs(ids ...uuid.UUID) *CommentUpdate {
...
func (cu *CommentUpdate) SetCourseCommentID(id int) *CommentUpdate {
	cu.mutation.SetCourseCommentID(id)
	return cu
}

// SetNillableCourseCommentID sets the "course_comment" edge to the CourseComment entity by ID if the given value is not nil.
func (cu *CommentUpdate) SetNillableCourseCommentID(id *int) *CommentUpdate {
	if id != nil {
		cu = cu.SetCourseCommentID(*id)
	}
	return cu
}

// SetCourseComment sets the "course_comment" edge to the CourseComment entity.
func (cu *CommentUpdate) SetCourseComment(c *CourseComment) *CommentUpdate {
	return cu.SetCourseCommentID(c.ID)
}

// AddLikedUserIDs adds the "liked_users" edge to the User entity by IDs.
func (cu *CommentUpdate) AddLikedUserIDs(ids ...uuid.UUID) *CommentUpdate {
...
func (cu *CommentUpdate) ClearObject() *CommentUpdate {
...
func (cu *CommentUpdate) RemoveChildIDs(ids ...uuid.UUID) *CommentUpdate {
...
func (cu *CommentUpdate) ClearCourseComment() *CommentUpdate {
	cu.mutation.ClearCourseComment()
	return cu
}
...
func (cu *CommentUpdate) RemoveLikedUserIDs(ids ...uuid.UUID) *CommentUpdate {
...
func (cu *CommentUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := cu.mutation.AddedScore(); ok {
		_spec.AddField(comment.FieldScore, field.TypeInt, value)
	}
	...
	if cu.mutation.CourseCommentCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2O,
			Inverse: false,
	...
	if nodes := cu.mutation.CourseCommentIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2O,
			Inverse: false,
			Table:   comment.CourseCommentTable,
...
// SetScore sets the "score" field.
func (cuo *CommentUpdateOne) SetScore(i int) *CommentUpdateOne {
...
// SetNillableScore sets the "score" field if the given value is not nil.
func (cuo *CommentUpdateOne) SetNillableScore(i *int) *CommentUpdateOne {
	if i != nil {
		cuo.SetScore(*i)
	}
	return cuo
...
// AddScore adds i to the "score" field.
func (cuo *CommentUpdateOne) AddScore(i int) *CommentUpdateOne {
...
// SetObjectID sets the "object" edge to the Object entity by ID.
func (cuo *CommentUpdateOne) SetObjectID(id uuid.UUID) *CommentUpdateOne {
	cuo.mutation.SetObjectID(id)
	return cuo
}

// SetNillableObjectID sets the "object" edge to the Object entity by ID if the given value is not nil.
func (cuo *CommentUpdateOne) SetNillableObjectID(id *uuid.UUID) *CommentUpdateOne {
	if id != nil {
		cuo = cuo.SetObjectID(*id)
	}
	return cuo
}

// SetObject sets the "object" edge to the Object entity.
func (cuo *CommentUpdateOne) SetObject(o *Object) *CommentUpdateOne {
...
// AddChildIDs adds the "children" edge to the Comment entity by IDs.
func (cuo *CommentUpdateOne) AddChildIDs(ids ...uuid.UUID) *CommentUpdateOne {
...
// SetCourseCommentID sets the "course_comment" edge to the CourseComment entity by ID.
func (cuo *CommentUpdateOne) SetCourseCommentID(id int) *CommentUpdateOne {
	cuo.mutation.SetCourseCommentID(id)
	return cuo
}

// SetNillableCourseCommentID sets the "course_comment" edge to the CourseComment entity by ID if the given value is not nil.
func (cuo *CommentUpdateOne) SetNillableCourseCommentID(id *int) *CommentUpdateOne {
	if id != nil {
		cuo = cuo.SetCourseCommentID(*id)
	}
	return cuo
}

// SetCourseComment sets the "course_comment" edge to the CourseComment entity.
func (cuo *CommentUpdateOne) SetCourseComment(c *CourseComment) *CommentUpdateOne {
	return cuo.SetCourseCommentID(c.ID)
}

// AddLikedUserIDs adds the "liked_users" edge to the User entity by IDs.
func (cuo *CommentUpdateOne) AddLikedUserIDs(ids ...uuid.UUID) *CommentUpdateOne {
...
// ClearObject clears the "object" edge to the Object entity.
func (cuo *CommentUpdateOne) ClearObject() *CommentUpdateOne {
...
// RemoveChildIDs removes the "children" edge to Comment entities by IDs.
func (cuo *CommentUpdateOne) RemoveChildIDs(ids ...uuid.UUID) *CommentUpdateOne {
...
// ClearCourseComment clears the "course_comment" edge to the CourseComment entity.
func (cuo *CommentUpdateOne) ClearCourseComment() *CommentUpdateOne {
	cuo.mutation.ClearCourseComment()
	return cuo
}
...
// RemoveLikedUserIDs removes the "liked_users" edge to User entities by IDs.
func (cuo *CommentUpdateOne) RemoveLikedUserIDs(ids ...uuid.UUID) *CommentUpdateOne {
...
func (cuo *CommentUpdateOne) sqlSave(ctx context.Context) (_node *Comment, err error) {
	...
	if cuo.mutation.CourseCommentCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2O,
			Inverse: false,
			Table:   comment.CourseCommentTable,
	...
	if nodes := cuo.mutation.CourseCommentIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2O,
			Inverse: false,
			Table:   comment.CourseCommentTable,
